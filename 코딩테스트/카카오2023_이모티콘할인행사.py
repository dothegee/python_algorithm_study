    ...
    for j in range(len(sales)):
        ...
        for i in range(len(users)):
            ...
            if users[i][0]>=sales[j]:
                ...
                add=0
                while add > users[i][2]:
                    add += emoticons[num]*(1-sales[j])
                    num+=1
        answer_list.append([signin,earning])
        print(answer_list)
    answer = []
    return answer


user1=[[40, 10000], [25, 10000]]
emoticons1=	[7000, 9000]
user2=[[40, 2900], [23, 10000], [11, 5200], [5, 5900], [40, 3100], [27, 9200], [32, 6900]]
emoticons2=[1300, 1500, 1600, 4900]
solution(user1,emoticons1)
solution(user2,emoticons2)